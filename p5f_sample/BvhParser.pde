...
//      System.out.println(prop + " + " + n + " " + bone.getName());
      if(bone != null) {
        Method getterMethod;
        try {
          ...
          e.printStackTrace();
          System.err.println("ERROR WHILST IN GETTING FRAME - 1");
        } catch (NoSuchMethodException e) {
          e.printStackTrace();
          System.err.println("ERROR WHILST IN GETTING FRAME - 2");
        } catch (IllegalArgumentException e) {
          e.printStackTrace();
          System.err.println("ERROR WHILST IN GETTING FRAME - 3");
        } catch (IllegalAccessException e) {
          e.printStackTrace();
          System.err.println("ERROR WHILST IN GETTING FRAME - 4");
        } catch (InvocationTargetException e) {
          e.printStackTrace();
          System.err.println("ERROR WHILST IN GETTING FRAME - 5");
        }
      }
      count++;
    }      
